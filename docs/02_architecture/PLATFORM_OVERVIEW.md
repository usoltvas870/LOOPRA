...
Этот документ описывает платформу **LOOPRA** на верхнем уровне.
...
**LOOPRA** — это Autonomous Marketing Operating System: standalone мультипроектная платформа для системного производства, упаковки, ручной публикации и базовой аналитики контента.
...
LOOPRA не должен быть зашит под один бренд, один продукт, одну нишу или один набор примеров. Все project-specific правила должны жить только в project layer.
...
LOOPRA нужен как нейтральный foundation, который задаёт единый контур:
