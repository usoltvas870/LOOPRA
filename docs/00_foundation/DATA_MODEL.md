...
## 14. Current Stage 2 Slice 1 Intelligence Entities
...
Stage 2 Slice 2 hardens this manual deterministic model: reviewed signals and active patterns have explicit service lifecycle paths, and conversion requires a non-empty `idea_id` at the domain boundary.
...
Updated: 2026-07-10
Project: LOOPRA
Current model scope: Foundation MVP plus bounded manual Content Intelligence
