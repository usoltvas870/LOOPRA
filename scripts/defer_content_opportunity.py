...
USAGE = """\
Defer one ContentOpportunity.

Usage:
  python scripts/defer_content_opportunity.py [--help | -h] [--json] <project_id> <content_opportunity_id>
"""
...
def main() -> int:
    ...
    try:
        opportunity = service().defer_content_opportunity(args[0], args[1])
        return dump_success(
